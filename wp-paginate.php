<?php
/*
Plugin Name: post type pagination
Plugin URI: https://wordpress.org/plugins/
Description: A simple and flexible pagination plugin for WordPress posts and comments.
Version: 1.0
Author: post type pagination
Text Domain: 'post type pagination'
*/
 
 
 
function post_type_pagination_activate()
{
global $wpdb; 
...
register_activation_hook( __FILE__, 'post_type_pagination_activate' );
...
if (!class_exists('WPPaginate')) {
    class WPPaginate {
        ...
        function admin_menu_link() {
            add_options_page('post-type-pagination', 'post-type-pagination', 'manage_options', basename(__FILE__), array(&$this, 'admin_options_page'));
...
<?php wp_nonce_field('wp-paginate-update-options'); ?>
    ...
    <table class="form-table">
        ...
        <tr valign="top">
            <th scope="row"><?php _e('post-type-pagination CSS File:', 'wp-paginate'); ?></th>
            <td><label for="css">
                <input type="checkbox" id="css" name="css" <?php echo ($this->options['css'] === true) ? "checked='checked'" : ""; ?>/> <?php printf(__('Include the default stylesheet wp-paginate.css? post-type-pagination will first look for <code>wp-paginate.css</code> in your theme directory (<code>themes/%s</code>).', 'wp-paginate'), get_template()); ?></label></td>
        </tr>
        <?php
        if(!isset($this->options['slash']))
...
<?php
    ...
    if( current_user_can( 'manage_options' ) ) {  ?>
      <div class="updated notice wpp-notice">         
        ...
        <div id='wpp-notice-1'><p id='wpp-notice-title'><?php _e( 'Love post-type-pagination?', 'wp-paginate' ); ?></p>
  ...
  public function wpp_dismiss_notice() {
	...
	function wpp_upgrade_to_pro_tab() {
		...
		<div id="utp-content">
			...
			<div class="utp-text">
				<?php _e('post-type-pagination Pro come with 11 Beautiful<br>Preset Layouts and Multi Site support!', 'wp-paginate'); ?>
			</div>
